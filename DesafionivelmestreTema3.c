...
//a partir daqui pra baixo são variaveis das cartas do jogo.
    ...
    char nomecidade2[50];
    int comparar1, comparar2, ciclo = 1;
    char usados[8] = {0};
...
*/
    ...
    unsigned long long int totalcarta1, totalcarta2;

    totalcarta1 = (unsigned long long int) superpodercarta1 + (unsigned long long int) populacao1; //escolhi esses 2 atributos para somar e decidir a vitoria atraves deles, superpoder e populacao
    totalcarta2 = (unsigned long long int) superpodercarta2 + (unsigned long long int) populacao2;
...
//comparacoes das 2 cartas e qual venceu!
    ...
    while(ciclo){
      ...
      printf("voce deseja comparar as cartas separadamente? \n\n");
      printf("digite '1' para sim, '2' para nao e encerrar o jogo.\n");
      scanf("%d", &comparar1);
     
    switch (comparar1){ //escolha das opcoes

case 1:
    
      printf("escolha a opcao: \n");
      if (usados[1] == 0){printf("1. Populacao\n");}
      if (usados[2] == 0){printf("2. Area\n");}
      if (usados[3] == 0){printf("3. PIB\n");}
      if (usados[4] == 0){printf("4. Pontos Turisticos\n");}
      if (usados[5] == 0){printf("5. Densidade\n");}
      if (usados[6] == 0){printf("6. Pib per Capita\n");}
      if (usados[7] == 0){printf("7. Super Poder\n");}
      printf("0. Sair da Comparacao\n");
      scanf("%d", &comparar2);

     /* esse comparar 2 esta sendo utilizado para o ciclo de comparacoes
      o comparar 1 e apenas para a escolha das opcoes
     */

      switch(comparar2){ //comparacoes
...
case 1:   //populacao
          ...
          if (usados[comparar2] == 1){
          printf("voce ja comparou este atributo, tente outro!\n\n");
          continue;
          }
          usados[comparar2] = 1;
          ...
          printf("Populacao: Carta 1 Venceu neste Atributo!\n\n");
          } else if (populacao1 < populacao2){
          printf("Populacao: Carta 2 Venceu neste Atributo!\n\n");
          } else if (populacao1 == populacao2){
...
case 2:   //area
          ...
          if (areakm1 > areakm2){
          printf("Area: Carta 1 Venceu neste Atributo!\n\n");
          } else if (areakm1 < areakm2){
          printf("Area: Carta 2 Venceu neste Atributo!\n\n");
          } else if (areakm1 == areakm2){
          printf("Area: ==Empate==\n\n");
          }
...
case 3:   //pib
          ...
          if (pib1 > pib2){
          printf("PIB: Carta 1 Venceu neste Atributo!\n\n");
          } else if (pib1 < pib2){
          printf("PIB: Carta 2 Venceu neste Atributo!\n\n");
          } else if (pib1 == pib2){
          printf("PIB: ==Empate==\n\n");
          }
...
case 4:   //pontosturisticos
          ...
          printf("Pontos Turisticos: Carta 1 Venceu neste Atributo!\n\n");
          } else if (pontostu1 < pontostu2){
          printf("Pontos Turisticos: Carta 2 Venceu neste Atributo!\n\n");
          } else if (pontostu1 == pontostu2){
...
case 5:   //densidade
          ...
          printf("Densidade Populacional: Carta 1 Venceu neste Atributo!\n\n");
          } else if (densidade1 > densidade2){
          printf("Densidade Populacional: Carta 2 Venceu neste Atributo!\n\n");
          } else if (densidade1 == densidade2){
...
case 6:   //pibpercapita
          ...
          printf("PIB per Capita: Carta 1 Venceu neste Atributo!\n\n");
          } else if (pibcapita1 < pibcapita2){
          printf("PIB per Capita: Carta 2 Venceu neste Atributo!\n\n");
          } else if (pibcapita1 == pibcapita2){
...
case 7:   //superpoder
          ...
          printf("Super Poder: Carta 1 Venceu neste Atributo!\n\n");
          } else if (superpodercarta1 < superpodercarta2){
          printf("Super Poder: Carta 2 Venceu neste Atributo!\n\n");
          } else if (superpodercarta1 == superpodercarta2){
...
default:  //caso escolha outra coisa aleatoria
...
default:  //caso escolha algo aleatorio em comparar1
          printf("--Opcao invalida--\n");
          break;
}
    }
...
//fim do programa//
    ...
    default: //caso escolha algo aleatorio em opcao1
